...
public class TileEntityFusion extends TileEntityBaseGenerator
{
    ...
    public boolean gainFuel()
    {
        ...
        {
            if (inventory[2].itemID == mod_RocketScience.itemDeuteriumCell.shiftedIndex)
            {
                fueltype = 1;
                i = 10000;
            }
            else if (inventory[2].itemID == mod_RocketScience.itemTritiumCell.shiftedIndex)
            {
                fueltype = 3;
                i = 10000;
            }
        ...
        else if (inventory[2].itemID == mod_RocketScience.itemDeuteriumCell.shiftedIndex)
        {
            ...
            else if (inventory[1].itemID == mod_RocketScience.itemTritiumCell.shiftedIndex)
            {
                fueltype = 3;
                i = 10000;
            }
    ...
    public void updateEntity()
    {
        ...
        if (!ignited() && hasCoils() && fuel > 0)
        {
            ...
            if (energy > 0 && hasHeaters() && hasCoils() && fuel > 0)
            {
                ...
                {
                    if (energy > 0 && inventory[panda] != null && inventory[panda].itemID == mod_RocketScience.itemRfHeaterId + 256)
                    {
                        energy -= 15;
                        heat += 10;
                    }
                    else if (energy > 0 && inventory[panda] != null && inventory[panda].itemID == mod_RocketScience.itemNeutralHeaterId + 256)
                    {
                        energy -= 20;
                        heat += 10;
                    }
                    else if (energy > 0 && inventory[panda] != null && inventory[panda].itemID == mod_RocketScience.itemOhmicHeaterId + 256)
                    {
                        int i = (5000 - heat) / 500;
                        energy -= i;
                        heat += i;
        ...
        if (ignited())
        {
            ...
            if (inventory[7] != null && inventory[7].itemID == mod_RocketScience.itemLithium6Cell.shiftedIndex)
            {
                bred += 1;
                ...
                if (bred >= 9500)
                {
                    ...
                    if (inventory[1] != null && inventory[2] != null)
                    {
                        if (inventory[1].itemID == mod_RocketScience.itemDeuteriumCell.shiftedIndex && inventory[2].itemID == mod_RocketScience.itemDeuteriumCell.shiftedIndex && inventory[2].stackSize + inventory[1].stackSize <= 64)
                        {
                            inventory[1].stackSize += inventory[2].stackSize;
                            inventory[2] = new ItemStack(mod_RocketScience.itemTritiumCell);
                            tritty = true;
                        }
                        else if (inventory[1].itemID == mod_RocketScience.itemDeuteriumCell.shiftedIndex && inventory[2].itemID == mod_RocketScience.itemTritiumCell.shiftedIndex && inventory[2].stackSize < 64)
                        {
                            inventory[2].stackSize++;
                            tritty = true;
                        }
                        else if (inventory[2].itemID == mod_RocketScience.itemDeuteriumCell.shiftedIndex && inventory[1].itemID == mod_RocketScience.itemTritiumCell.shiftedIndex && inventory[1].stackSize < 64)
                        {
                            inventory[1].stackSize++;
                            tritty = true;
                        }
                    ...
                    {
                        if (inventory[2] != null && inventory[2].itemID == mod_RocketScience.itemTritiumCell.shiftedIndex && inventory[2].stackSize < 64)
                        {
                            inventory[2].stackSize++;
                            tritty = true;
                        }
                    ...
                    {
                        if (inventory[1] != null && inventory[1].itemID == mod_RocketScience.itemTritiumCell.shiftedIndex && inventory[1].stackSize < 64)
                        {
                            inventory[1].stackSize++;
                            tritty = true;
                        }
        ...
        if ((fuel <= 0 || inventory[3] == null || (inventory[3].itemID != mod_RocketScience.itemSuperCoilsId + 256 && inventory[3].itemID != mod_RocketScience.itemCopperCoilsId + 256)) && heat > 0)
        {
            heat -= 100;
            storage += 100;
    ...
    {
        return inventory[3] != null && (inventory[3].itemID == mod_RocketScience.itemCopperCoilsId + 256 || inventory[3].itemID == mod_RocketScience.itemSuperCoilsId + 256);
    }
    ...
    public boolean hasHeaters()
    {
        for (int panda = 4; panda <= 6; panda++)
        {
            if (inventory[panda] != null && (inventory[panda].itemID == mod_RocketScience.itemOhmicHeaterId + 256 || inventory[panda].itemID == mod_RocketScience.itemNeutralHeaterId + 256 || inventory[panda].itemID == mod_RocketScience.itemRfHeaterId + 256))
            {
                return true;
            }
        }
