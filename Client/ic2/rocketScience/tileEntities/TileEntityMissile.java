...
public class TileEntityMissile extends TileEntity implements IEnergySource, IEnergySink
{

    public TileEntityMissile()
    {
        targetX = 0;
        targetZ = 0;
	...
	System.out.println("ModLoader.getMinecraftInstance().isMultiplayerWorld():"+ModLoader.getMinecraftInstance().isMultiplayerWorld());
	System.out.println("Platform.isSimulating():"+Platform.isSimulating());
	System.out.println("Platform.isRendering():"+Platform.isRendering());
        ...
        if (!worldObj.isRemote && player != null && (worldObj.getBlockMetadata(xCoord, yCoord, zCoord) == 12 || worldObj.getBlockMetadata(xCoord, yCoord, zCoord) == 15 || worldObj.getBlockMetadata(xCoord, yCoord, zCoord) == 0))
        {
            EntityMissilePassengerBooster tittytoo = new EntityMissilePassengerBooster(worldObj, xCoord, yCoord, zCoord);
        ...
        {
            EntityMissileBooster titty = new EntityMissileBooster(worldObj, xCoord, yCoord, zCoord); //,titty.targetX,titty.targetZ,world.getBlockMetadata(i,j,k));
