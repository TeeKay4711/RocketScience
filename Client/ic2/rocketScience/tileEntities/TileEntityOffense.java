...
public class TileEntityOffense extends TileEntityBlock implements IEnergySink, IEnergySource
{
    ...
    public void updateAttachedMissiles()
    {
        ...
        while (it.hasNext())
        {
            ...
            if (attachedDevice instanceof TileEntityMissile)
            {
                attachedMissiles.add(attachedDevice);
                ((TileEntityMissile)attachedDevice).targetX = ecks;
                ((TileEntityMissile)attachedDevice).targetZ = zee;
            }
        }
    }
    ...
    public void fireMissiles()
    {
        ...
        {
            ((TileEntityMissile)missiles[i]).launch(null);
        }
