...
import ic2.rocketScience.tileEntities.TileEntitySuperconductor;
...
public class BlockSuperconductor extends BlockMultiID
{
    ...
    {
        return mod_RocketScience.blockSuperconductorId;
    }
    ...
    public ArrayList getBlockDropped(World world, int i, int j, int k, int l, int i1)
    {
        ...
        arraylist.add(new ItemStack(mod_RocketScience.blockSuperconductor));
        return arraylist;
    }
