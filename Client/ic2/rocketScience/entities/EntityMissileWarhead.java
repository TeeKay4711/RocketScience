...
public class EntityMissileWarhead extends EntityLiving
{
    ...
    public EntityMissileWarhead(World world)
    {
    	super(world);
    	rider=null;
        if(type==12)
    ...
    public EntityMissileWarhead(World world, double i, double j, double k)
    {
        super(world);
        setPosition(i + .5f, j, k + .5f);
        rider = null;
    ...
    public void explode()
    {
        ...
        else if (type == 12)
        {
            ...
            //EntityMissileDummy.updateFall(rider, 0);
            rider = null;
