...
public class EntityRangefinder extends Entity
{

    EntityPlayer player;

    public EntityRangefinder(World world, EntityLiving entityliving, float f)
    {
        super(world);
    ...
    private void reportRange(int x, int y, int z, int block)
    {
        ...
        setDead();
        ItemRangefinder.ecks = (x - (int)player.posX);
        ItemRangefinder.zee = (z - (int)player.posZ);
    }
}
