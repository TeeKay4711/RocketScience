...
public class EntityMissileMinerBooster extends EntityLiving
{
    ...
    public EntityMissileMinerBooster(World world)
    {
        super(world);
        texture = "/ic2/rocketScience/gfx/MissileMiner.png";
        inventory = new ItemStack[27];
    }

    public EntityMissileMinerBooster(World world, double i, double j, double k)
    {
        super(world);
        speed = 0;
        //targetX=x;
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            {
                worldObj.setBlockAndMetadataWithNotify((int)Math.floor(posX), (int)Math.floor(posY), (int)Math.floor(posZ), mod_RocketScience.blockMachineId, 1);
    ...
    {
        return "/ic2/rocketScience/gfx/MissileMiner.png";
    }
